...
import HealthHabits from "./HealthHabits.jsx";
...
export default function AppShell() {
  ...
  // Android hardware back button (Part 27). No-op everywhere except
  // inside the Capacitor Android shell — guarded, same pattern as
  // app/www/trades/capacitor-bridge.js.
  useEffect(() => {
